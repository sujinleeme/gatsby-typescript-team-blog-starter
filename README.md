...
*  Gatsby, Typescript, GraphQL, styled components.
*  For development,  `yarn install` then `yarn develop`.

### Features
* Support Mutiple authors
* Markdown Blog Posts
* Markdown Single Post for About, Contact.. etc.
* TODO : categories, tags


#### Refs.
* Sample Images for Avatars : [flaticon - Pokemon Go Icon Pack](https://www.flaticon.com/packs/pokemon-go)
* Codebase : [Gatsby-starter-blog](https://github.com/gatsbyjs/gatsby-starter-blog)
